...
func routes(_ app: Application) async throws {
    ...
    try app.register(collection: CompanyController(syncManager: syncManager, validator: validator))
    try app.register(collection: SubsidiaryController(syncManager: syncManager, validator: validator))
    ...
    try app.register(collection: EmployeeController(syncManager: syncManager, validator: validator))
